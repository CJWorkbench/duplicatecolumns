...
#. Write a test in ``test_duplicatecolumns.py``
#. Run ``python3 ./setup.py test`` to prove it breaks
#. Edit ``duplicatecolumns.py`` to make the test pass
...
#. In a separate tab in the Workbench directory, run ``bin/dev develop-module duplicatecolumns``
